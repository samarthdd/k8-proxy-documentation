...
- Configure the Alternate Access Mapping. On SharePoint Server Central Administration, go to 'Central Admin > Application Management > Alternate Access Mappings > Edit Zone URL'
- Edit the Public Zone URLs:
- The default entry should be the system internal URL. The intranet entry should be the public IP.

![step 6](../../../../../static/img/docs/websites/sharepoint/server/manual-install-11.png)
